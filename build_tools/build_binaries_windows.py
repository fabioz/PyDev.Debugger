...
C:\tools\Miniconda32\Scripts\conda create -y -f -n py26_32 python=2.6 cython numpy nose ipython pip
C:\tools\Miniconda32\Scripts\activate py26_32
...
C:\tools\Miniconda\Scripts\conda create -y -f -n py26_64 python=2.6 cython numpy nose ipython pip
C:\tools\Miniconda\Scripts\activate py26_64
pip install "django>=1.7,<1.8"
pip install -U "setuptools>=0.9"
pip install -U "pip>=1.4" "wheel>=0.21" twine
deactivate
