...
int PythonVersion_Unknown = 0;
int PythonVersion_25 = 0x0205;
int PythonVersion_26 = 0x0206;
int PythonVersion_27 = 0x0207;
int PythonVersion_30 = 0x0300;
int PythonVersion_31 = 0x0301;
int PythonVersion_32 = 0x0302;
int PythonVersion_33 = 0x0303;
int PythonVersion_34 = 0x0304;
...
typedef struct _object {
    //_PyObject_HEAD_EXTRA -- only at debug (we'll skip it later).
    size_t ob_refcnt;
...
//
// // 2.4 - 2.7 compatible
// struct PyCodeObject25_27 : PyObject {
//
...
//
// // 3.0-3.2
// struct PyCodeObject30_32 : PyObject {
//
//     int co_argcount;        /* #arguments, except *args */
...
//
// // 3.3-3.4
// struct PyCodeObject33_34 : PyObject {
//
//     int co_argcount;            /* #arguments, except *args */
//     int co_kwonlyargcount;      /* #keyword only arguments */
//     int co_nlocals;             /* #local variables */
...
//
// // 2.5 - 3.1
// struct PyFunctionObject : PyObject {
//
//     PyObject *func_code;    /* A code object */
// };
//
// // 2.5 - 2.7 compatible
// struct PyStringObject : PyVarObject {
//
//     long ob_shash;
//     int ob_sstate;
//     char ob_sval[1];
...
// } PyTryBlock;
//
// struct PyFrameObject25_33 : PyFrameObject {
//
...
// };
//
// struct PyFrameObject34 : PyFrameObject {
//
...
//
// // 2.4 - 3.4
// struct PyCFunctionObject : PyObject {
//
...
//
// struct PyThreadState_25_27 : PyThreadState {
//
...
// };
//
// struct PyThreadState_30_33 : PyThreadState {
//
//     PyThreadState *next;
//     PyInterpreterState *interp;
//
...
// };
//
// struct PyThreadState_34 : PyThreadState {
//
//     PyThreadState *prev;
//     PyThreadState *next;
//     PyInterpreterState *interp;
...
// };
//
// struct PyIntObject : PyObject {
//
//     long ob_ival;
// };
//
// // struct Py3kLongObject : PyVarObject {
// //
// //     DWORD ob_digit[1];
// // };
//
// struct PyOldStyleClassObject : PyObject {
//
//     PyObject *cl_bases; /* A tuple of struct objects */
...
// };
//
// struct PyInstanceObject : PyObject {
//
//     PyOldStyleClassObject *in_class; /* The struct object */
